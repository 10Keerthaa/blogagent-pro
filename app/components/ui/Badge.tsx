...
interface BadgeProps {
    ...
    variant?: 'pending' | 'success' | 'destructive' | 'outline' | 'violet' | 'warning';
    className?: string;
}
...
export const Badge = ({
    ...
    const variants = {
        pending: 'bg-violet-50 text-violet-600 border border-violet-100 dark:bg-violet-950/20 dark:text-violet-400 dark:border-violet-900/50',
        ...
        warning: 'bg-amber-50 text-amber-600 border border-amber-100 dark:bg-amber-950/20 dark:text-amber-400 dark:border-amber-900/50',
