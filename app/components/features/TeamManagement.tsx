                    ...
                    <div className="mb-10 p-6 bg-slate-50 dark:bg-slate-900/50 border border-slate-100 dark:border-slate-800 flex flex-col md:flex-row items-end gap-6 group/add">
                        <div className="flex-1 space-y-2 w-full">
                            ...
                            <input 
                                ...
                                className="w-full bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/20 transition-all font-medium text-slate-700 dark:text-slate-300"
                            />
                        </div>
                        <div className="w-full md:w-48 space-y-2">
                            ...
                            <div className="relative">
                                <select 
                                    ...
                                    className="w-full bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 px-4 py-3 text-xs font-bold appearance-none cursor-pointer focus:outline-none focus:ring-2 focus:ring-indigo-500/20 transition-all uppercase tracking-widest text-slate-700 dark:text-slate-300"
                                >
                        ...
                        <button 
                            ...
                            className="bg-indigo-600 hover:bg-indigo-700 text-white px-8 py-3.5 text-[11px] font-black uppercase tracking-widest flex items-center gap-3 transition-all disabled:opacity-50 shadow-lg shadow-indigo-500/20"
                        >
