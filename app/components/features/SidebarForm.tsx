            ...
            <div className="py-8 pl-10 space-y-8 flex-1 bg-slate-50/30 dark:bg-transparent">
                ...
                <section className="space-y-4">
                    <div className="flex items-center justify-between">
                        <label className="text-[11px] font-bold uppercase tracking-wide text-slate-400 !pl-4">Keywords</label>
                        <button
                ...
                <section className="space-y-4">
                    <div className="flex items-center justify-between">
                        <label className="text-[11px] font-bold uppercase tracking-wide text-slate-400 !pl-4">Description</label>
                        <button
                    ...
                    {!isReadOnly && displayKeywords.length > 0 && !primaryKeyword && (
                        <div className="flex items-start gap-2 px-3 py-2.5 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-none ml-4">
