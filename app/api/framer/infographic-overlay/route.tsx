  ...
  try {
    ...
    if (titleNumber === 5 || titleNumber === 6 || titleNumber === 7 || layoutType === 'timeline') {
      ...
      return new ImageResponse(
        (
          <div style={{ width: '800px', height: '1000px', backgroundColor: '#1A0B2E', display: 'flex', flexDirection: 'column', position: 'relative', overflow: 'hidden', padding: '40px 50px', color: 'white' }}>
            {/* Header */}
        ...
        { width: 800, height: 1000, fonts: fonts }
      );
    }
    ...
    if (titleNumber === 8 || layoutType === 'grid') {
      return new ImageResponse(
        (
          <div style={{ width: '800px', height: '1000px', backgroundColor: '#1A0B2E', display: 'flex', flexDirection: 'column', position: 'relative', overflow: 'hidden', padding: '40px 45px', color: 'white' }}>
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '12px 15px', width: '710px', height: '620px' }}>
    ...
    return new ImageResponse(
      (
        <div style={{ width: '800px', height: '1000px', backgroundColor: '#1A0B2E', display: 'flex', flexDirection: 'column', position: 'relative', overflow: 'hidden', padding: '40px 50px', color: 'white' }}>
          ...
          <div style={{ width: '700px', height: '160px', backgroundColor: 'rgba(255, 255, 255, 0.12)', border: '1px solid rgba(255, 255, 255, 0.15)', borderRadius: '16px', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', position: 'relative', overflow: 'hidden', marginBottom: '10px' }}>
            {iconStripBase64 && (
              <img src={`data:image/png;base64,${iconStripBase64}`} style={{ position: 'absolute', top: '0px', left: '15px', width: '670px', height: '145px', objectFit: 'cover', objectPosition: 'center 15%' }} />
            )}
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', width: '700px', height: '630px' }}>
